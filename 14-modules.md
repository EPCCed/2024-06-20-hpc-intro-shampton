...
```bash
userid@uan01:/work/ta140/ta140/userid> module avail
```
...
```bash
userid@uan01:/work/ta140/ta140/userid> module list
```
```output
...
```bash
userid@uan01:/work/ta140/ta140/userid> nano ncdump-module.sh
userid@uan01:/work/ta140/ta140/userid> cat ncdump-module.sh
```
```output
#!/bin/bash
...
```bash
userid@uan01:/work/ta140/ta140/userid>  python-module.sh
```
:::
:::
