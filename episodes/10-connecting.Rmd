...
```{r showwd, results='asis', include=FALSE}
login_output <- paste('files/snippets/login_output.EPCC_ARCHER2', config$remote$host_id, sep='.')
```

```{r, child=login_output, eval=TRUE}
```
